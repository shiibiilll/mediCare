...
import { editProfilePageStyles, iconSize } from "../assets/styles/styles.js";
...
// Prevent from the duplicate slots
...
const EditProfilePage = ({ apiBase }) => {
  ...
  // Reset the profile back to initial
  ...
  const fieldConfigs = doc
    ? [
        ...
        },
        {
          ...
          value: doc.qualifications || doc.qualification || "",
