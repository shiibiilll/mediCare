...
const Navbar = () => {
  ...
  // Toggle the mobile menu ie:- close when we click on escape key
  useEffect(() => {
    const onKey = (e) => {
  ...
  // User signed in fetch a token and save it in localstorage
  useEffect(() => {
    let mounted = true;
    const storeToken = async () => {
      ...
      try {
        ...
        console.warn("Could not retrieve the clerk token", error);
      }
    };
    storeToken();
