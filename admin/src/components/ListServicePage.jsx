...
const ListServicePage = () => {
  ...
  // Slot the slots as latest come first by date
  ...
  // Converts array of slots into slot objects
  ...
  // Give output with date and time DD-MM-YYYY with HH:MM AM/PM format
  ...
  // Validate the slot is not previous days or time
  ...
  // Prevent duplicate slots to be presented
  ...
  // Format date for backend DD-MM-YYYY with HH:MM AM/PM
  ...
  // Edit any service we save then for a particular service
  ...
  function onImageFileChange(e) {
    ...
    if (editForm?.imagePreview && editForm.imagePreview.startsWith("blob:")) {
      try {
        ...
        console.error("onImageFileChange Error:", err);
      }
    }
