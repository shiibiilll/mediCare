...
// Take Slot With Date Time And Returns A Date Object
...
const AppointmentsPage = () => {
  const isAdmin = true; // As The Admin Is Logged In
    ...
    <div className={pageStyles.container}>
      ...
      <div className={pageStyles.maxWidthContainer}>
        <header className={pageStyles.headerContainer}>
          <div className={pageStyles.headerTitleSection}>
            ...
            <p className={pageStyles.headerSubtitle}>
              Manage and search upcoming patients appointments
            </p>
          </div>

          <div className={pageStyles.headerControlsSection}>
            <div
              className="flex flex-col md:flex-col sm:flex-row 
            ...
            >
              <div className={pageStyles.searchContainer}>
                ...
                <input
                  ...
                  placeholder="Search Doctor, Patient, Speciality, Mobile"
                  value={query}
        ...
        {loading ? (
          ...
          <div className={pageStyles.loadingErrorContainer}>{error}</div>
